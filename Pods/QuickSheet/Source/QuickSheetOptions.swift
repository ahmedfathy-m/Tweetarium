...
public struct QuickSheetOptions {
    ...
    /// A custom preset that allows you to present your screen at 90% height with scrolling disabled
    public static let staticFull = QuickSheetOptions(fraction: 0.9, isExpandable: false, isScrollable: false, cornerRadius: 5)
    /// A custom preset that allows you to present your screen at 90% height with scrolling enabled
    public static let dynamicFull = QuickSheetOptions(fraction: 0.9, isExpandable: false, isScrollable: true, cornerRadius: 5)
